<%@ Page Title="" Language="C#" UICulture="pl" Culture="pl-PL" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="aktc2.aspx.cs" Inherits="Statystyki_2018.aktc2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <style>
        ...
        @media print {
            ...
            .horizont {
                transform: translate(-50mm, 0) scale(0.65);
                -webkit-transform: translate(-50mm, 0) scale(0.65);
                -moz-transform: translate(-50mm, 0) scale(0.65);
                break-after: column;
            }
        }
    </style>
    ...
    <div style="width: 1150px; margin: 0 auto 0 auto; position: relative; top: 60px;">
        ...
        <div id="debag">
            ...
            &nbsp;Sporzadzone dn.
            <asp:Label ID="LbDataRaportu" runat="server"></asp:Label>&nbsp;przez&nbsp;&nbsp;&nbsp;
