<%@ Page Title="" Language="C#" UICulture="pl" Culture="pl-PL" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="oopr.aspx.cs" Inherits="Statystyki_2018.oopr" MaintainScrollPositionOnPostback="true" %>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCreated="grvMergeHeader_RowCreated" ShowHeader="False" Width="100%" CssClass="GridView1" ShowFooter="True" OnRowDataBound="GridView1_RowDataBound">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="d_01" SortExpression="d_01">
                        ...
                        <ItemStyle CssClass="col_120 center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="d_02" SortExpression="d_02">
                        ...
                        <ItemStyle CssClass="col_120 center gray" />
                    </asp:TemplateField>
