<%@ Page Title="" Language="C#" UICulture="pl" Culture="pl-PL" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="oopc.aspx.cs" Inherits="Statystyki_2018.oopc" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCreated="grvMergeHeader_RowCreated" ShowHeader="False" Width="100%" CssClass="GridView1" ShowFooter="True" OnRowDataBound="GridView1_RowDataBound">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="d_02" SortExpression="d_02">
                                ...
                                <ItemStyle CssClass="col_80_fest center" Width="150px" BackColor="#ccccccc" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="d_99" SortExpression="d_99">
                                <ItemTemplate>
                                    <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!5!99!5"%>')">
                                        <asp:Label ID="Label1093zsa" runat="server" Text='<%# Eval("d_99")%>' CssClass="normal"></asp:Label>
                                    </a>
                                </ItemTemplate>
                                <ItemStyle CssClass="col_80_fest center" />
                            </asp:TemplateField>
                        ...
                        <FooterStyle BackColor="#CCCCCC" CssClass="center" />
