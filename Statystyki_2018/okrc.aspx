<%@ Page Title="" Language="C#" UICulture="pl" Culture="pl-PL" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="okrc.aspx.cs" Inherits="Statystyki_2018.okrc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 1150px; margin: 0 auto 0 auto; position: relative; top: 60px;">
       ...
       <asp:Label ID="infoLabel2" runat="server" Text="Tabela 1\/" Visible="False"></asp:Label>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCreated="GridView1_RowCreated"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="imie" SortExpression="imie">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="funkcja" runat="server" Text='<%# Eval("funkcja") %>' CssClass="wrapText"></asp:Label>
                        </ItemTemplate>
        ...
        <br />
      <div style="width: 1150px; margin: 0 auto 0 auto; position: relative; top:50px">
