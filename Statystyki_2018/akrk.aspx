<%@ Page Title="" Language="C#" UICulture="pl" Culture="pl-PL" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="akrk.aspx.cs" Inherits="Statystyki_2018.akrk" %>
    ...
    <div style="width: 1150px; margin: 0 auto 0 auto; position: relative; top: 30px;">
        ...
        <div id="TABELA1">
            <table style="width: 100%;">
                <tr>
                    <td class="wciecie borderAll" rowspan="2">Ruch spraw</td>
                    <td class="borderAll center" colspan="13">Sprawy według repertoriów i wykazów </td>
                </tr>
                <tr>
                    <td class="center borderAll col_50">K</td>
                    <td class="center borderAll col_50">Ko</td>
                    <td class="center borderAll col_50">Kp</td>
                    <td class="center borderAll col_50">Kop</td>
                    <td class="center borderAll col_50">Ka</td>
                    <td class="center borderAll col_50">KZ</td>
                    <td class="center borderAll col_50">Kzw</td>
                    <td class="center borderAll col_50">WKK</td>
                    <td class="center borderAll col_50">Kow</td>
                    <td class="center borderAll col_50">Pen</td>
                    <td class="center borderAll col_50">WSU</td>
                    <td class="center borderAll col_50">S</td>
                    <td class="center borderAll col_50">Łącznie</td>
                </tr>
                <tr>
                    ...
                    <td class="center borderAll col_50" style="background-color: #CCCCCC">
