<%@ Page Title="" Language="C#" UICulture="pl" Culture="pl-PL" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ansk.aspx.cs" Inherits="Statystyki_2018.ansk"  MaintainScrollPositionOnPostback="true" %>
...
#menu.scrolling {
  ...
  <ItemStyle  CssClass="col_55" />
            ...
            <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                <ItemTemplate>
                        <uc2:PopupLinkButtom2 ID="PopupLinkButtom7" runat="server" info='<%# Eval("d_07")+"#"+Eval("id_")+ "#"+Eval("id_tabeli") +"#7#1"%>' />     
                </ItemTemplate>
                <ItemStyle  CssClass="col_55" />
            </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                <ItemTemplate>
                      <uc2:PopupLinkButtom2 ID="PopupLinkButtom8" runat="server" info='<%# Eval("d_08")+"#"+Eval("id_")+ "#"+Eval("id_tabeli") +"#8#1"%>' />     
                </ItemTemplate>
                <ItemStyle  CssClass="col_55" />
            </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                <ItemTemplate>
                     <uc2:PopupLinkButtom2 ID="PopupLinkButtom9" runat="server" info='<%# Eval("d_09")+"#"+Eval("id_")+ "#"+Eval("id_tabeli") +"#9#1"%>' />     
                </ItemTemplate>
                <ItemStyle  CssClass="col_55" />
            </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                <ItemTemplate>
                     <uc2:PopupLinkButtom2 ID="PopupLinkButtom10" runat="server" info='<%# Eval("d_10")+"#"+Eval("id_")+ "#"+Eval("id_tabeli") +"#10#1"%>' />     
                </ItemTemplate>
                <ItemStyle  CssClass="col_55" />
            </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                <ItemTemplate>
                     <uc2:PopupLinkButtom2 ID="PopupLinkButtom11" runat="server" info='<%# Eval("d_11")+"#"+Eval("id_")+ "#"+Eval("id_tabeli") +"#11#1"%>' />     
                </ItemTemplate>
                <ItemStyle  CssClass="col_55" />
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom12" runat="server" info='<%# Eval("d_12")+"#"+Eval("id_")+ "#"+Eval("id_tabeli") +"#12#1"%>' />     
                </ItemTemplate>
       ...
       <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="d_03" SortExpression="d_03">
                ...
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom18" runat="server" info='<%# Eval("d_03")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#3#2"%>' />     
            ...
            <asp:TemplateField HeaderText="d_04" SortExpression="d_04">
                ...
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom19" runat="server" info='<%# Eval("d_04")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#4#2"%>' />     
            ...
            <asp:TemplateField HeaderText="d_05" SortExpression="d_05">
                ...
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom20" runat="server" info='<%# Eval("d_05")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#5#2"%>' />     
            ...
            <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                ...
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom21" runat="server" info='<%# Eval("d_06")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#6#2"%>' />     
            ...
            <asp:TemplateField HeaderText="d_07" SortExpression="d_07">
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom22" runat="server" info='<%# Eval("d_07")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#7#2"%>' />     
            ...
            <asp:TemplateField HeaderText="d_07" SortExpression="d_07">
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom23" runat="server" info='<%# Eval("d_08")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#8#2"%>' />     
            ...
            <asp:TemplateField HeaderText="d_07" SortExpression="d_07">
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom24" runat="server" info='<%# Eval("d_09")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#9#2"%>' />     
            ...
            <asp:TemplateField HeaderText="d_07" SortExpression="d_07">
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom25" runat="server" info='<%# Eval("d_10")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#10#2"%>' />     
         ...
         <asp:TemplateField HeaderText="d_07" SortExpression="d_07">
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom26" runat="server" info='<%# Eval("d_11")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#11#2"%>' />     
             ...
             <asp:TemplateField HeaderText="d_07" SortExpression="d_07">
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom27" runat="server" info='<%# Eval("d_12")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#12#2"%>' />     
             ...
             <asp:TemplateField HeaderText="d_07" SortExpression="d_07">
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom28" runat="server" info='<%# Eval("d_13")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#13#2"%>' />     
             ...
             <asp:TemplateField HeaderText="d_07" SortExpression="d_07">
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom29" runat="server" info='<%# Eval("d_14")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#14#2"%>' />     
             ...
             <asp:TemplateField HeaderText="d_07" SortExpression="d_07">
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom30" runat="server" info='<%# Eval("d_15")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#15#2"%>' />     
             ...
             <asp:TemplateField HeaderText="d_07" SortExpression="d_07">
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom31" runat="server" info='<%# Eval("d_16")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#16#2"%>' />     
             ...
             <asp:TemplateField HeaderText="d_07" SortExpression="d_07">
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom32" runat="server" info='<%# Eval("d_17")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#17#2"%>' />     
                  ...
                  <ItemStyle  CssClass="col_36" />
                         ...
                         <asp:TemplateField HeaderText="d_07" SortExpression="d_07">
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom33" runat="server" info='<%# Eval("d_18")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#18#2"%>' />     
                  ...
                  <ItemStyle  CssClass="col_36" />
                         ...
                         <asp:TemplateField HeaderText="d_07" SortExpression="d_07">
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom34" runat="server" info='<%# Eval("d_19")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#19#2"%>' />     
                  ...
                  <ItemStyle  CssClass="col_36" />
                              ...
                              <asp:TemplateField HeaderText="d_07" SortExpression="d_07">
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom35" runat="server" info='<%# Eval("d_20")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#20#2"%>' />     
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="d_05" SortExpression="d_05">
              ...
              <asp:TemplateField HeaderText="d_05" SortExpression="d_05">
                ...
                <ItemTemplate>
                     <uc2:PopupLinkButtom2 ID="PopupLinkButtom45" runat="server" info='<%# Eval("d_07")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#7#2"%>' />     
                </ItemTemplate>
              <ItemStyle cssclass="col_55" />
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="d_05" SortExpression="d_05">
                ...
                <ItemTemplate>
                     <uc2:PopupLinkButtom2 ID="PopupLinkButtom46" runat="server" info='<%# Eval("d_08")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#8#2"%>' />     
                </ItemTemplate>
              <ItemStyle cssclass="col_55" />
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="d_05" SortExpression="d_05">
                ...
                <ItemTemplate>
                    <uc2:PopupLinkButtom2 ID="PopupLinkButtom47" runat="server" info='<%# Eval("d_09")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#9#2"%>' />                          
                </ItemTemplate>
              <ItemStyle cssclass="col_55" />
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="d_05" SortExpression="d_05">
                ...
                <ItemTemplate>
                     <uc2:PopupLinkButtom2 ID="PopupLinkButtom48" runat="server" info='<%# Eval("d_10")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#10#2"%>' />     
                </ItemTemplate>
              <ItemStyle cssclass="col_55" />
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="d_05" SortExpression="d_05">
                ...
                <ItemTemplate>
                     <uc2:PopupLinkButtom2 ID="PopupLinkButtom49" runat="server" info='<%# Eval("d_11")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#11#2"%>' />     
                </ItemTemplate>
              <ItemStyle cssclass="col_55" />
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="d_05" SortExpression="d_05">
                ...
                <ItemTemplate>
                     <uc2:PopupLinkButtom2 ID="PopupLinkButtom50" runat="server" info='<%# Eval("d_12")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#12#2"%>' />     
                </ItemTemplate>
              <ItemStyle cssclass="col_55" />
            </asp:TemplateField>
             ...
             <asp:TemplateField HeaderText="d_05" SortExpression="d_05">
                ...
                <ItemTemplate>
                     <uc2:PopupLinkButtom2 ID="PopupLinkButtom51" runat="server" info='<%# Eval("d_13")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#13#2"%>' />     
                </ItemTemplate>
              <ItemStyle cssclass="col_55" />
            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="tabela_5" runat="server" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="d_04" SortExpression="d_04">
                ...
                <ItemTemplate>
                <uc1:PopupLinkButtom ID="PopupLinkButtom89" runat="server" info='<%# Eval("d_04")+"#"+Eval("id_sedziego")+ "#"+Eval("id_tabeli") +"#4#2"%>' />                     </ItemTemplate>
                <ItemStyle cssclass="col_82" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="d_05" SortExpression="d_05">
