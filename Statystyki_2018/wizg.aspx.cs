...
{
    public partial class wizg : System.Web.UI.Page
    {
        ...
        private const string tenPlik = "wizg.aspx";
        public string tenPlikNazwa = "wizg";
        ...
        protected void tabela_8()
        {
            ...
            {
                int idWiersza = 0;
                tab_8_w01_c01.Text = tabelka01.Rows[idWiersza]["d_01"].ToString().Trim();
                tab_8_w01_c02.Text = tabelka01.Rows[idWiersza]["d_02"].ToString().Trim();
                tab_8_w01_c03.Text = tabelka01.Rows[idWiersza]["d_03"].ToString().Trim();
                tab_8_w01_c04.Text = tabelka01.Rows[idWiersza]["d_04"].ToString().Trim();
                tab_8_w01_c05.Text = tabelka01.Rows[idWiersza]["d_05"].ToString().Trim();
                tab_8_w01_c06.Text = tabelka01.Rows[idWiersza]["d_06"].ToString().Trim();
                tab_8_w01_c07.Text = tabelka01.Rows[idWiersza]["d_07"].ToString().Trim();
                tab_8_w01_c08.Text = tabelka01.Rows[idWiersza]["d_08"].ToString().Trim();
                tab_8_w01_c09.Text = tabelka01.Rows[idWiersza]["d_09"].ToString().Trim();
                tab_8_w01_c10.Text = tabelka01.Rows[idWiersza]["d_10"].ToString().Trim();
                tab_8_w01_c11.Text = tabelka01.Rows[idWiersza]["d_11"].ToString().Trim();
                tab_8_w01_c12.Text = tabelka01.Rows[idWiersza]["d_12"].ToString().Trim();
        ...
        protected void tabela_15()
        {
            ...
            string path = Server.MapPath("XMLHeaders") + "\\wizg.xml";
        ...
        protected void tabela_22()
        {
            ...
            {
                int id_ = 0;
                tab_22_w01_c01.Text = tabelka01.Rows[id_]["d_01"].ToString().Trim();
                tab_22_w01_c02.Text = tabelka01.Rows[id_]["d_02"].ToString().Trim();
                tab_22_w01_c03.Text = tabelka01.Rows[id_]["d_03"].ToString().Trim();
                tab_22_w01_c04.Text = tabelka01.Rows[id_]["d_04"].ToString().Trim();
                tab_22_w01_c05.Text = tabelka01.Rows[id_]["d_05"].ToString().Trim();
                tab_22_w01_c06.Text = tabelka01.Rows[id_]["d_06"].ToString().Trim();
            ...
            {
                cm.log.Error(tenPlik + ": Tabela 22  " +ex.Message);
            }
        }
        ...
        protected void naglowekTabeli_gwTabela1(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                string path = Server.MapPath("\\Template\\wizg_aspx.xlsx");
        ...
        protected void tworztabelkeHTML(string idKontrolki, int idWydzialu, int idtabeli, DataTable dane)
        {
            ...
            builder.AppendLine("<td class='borderAll center' colspan='9'>kategoria spraw</td>");
            ...
            builder.AppendLine("<td class='borderAll center col_100' colspan='2'>CG</td>");
            builder.AppendLine("<td class='borderAll center col_100' colspan='2'>GNc</td>");
            builder.AppendLine("<td class='borderAll center col_100' colspan='2'>GCo</td>");
            builder.AppendLine("<td class='borderAll center col_100' colspan='2'>GNs</td> </tr><tr>");
        ...
        protected void tworztabelkeHTML2(string idKontrolki, int idWydzialu, int idtabeli, DataTable dane)
        {
            ...
            builder.AppendLine("<td class='borderAll center col_100' rowspan='3'>sprawdzenie(do usunięcia po sprawdzeniu) suma musi dać 100</td>	</tr><tr>");
            builder.AppendLine("<td class='borderAll center col_100'>ogółem</td>");
            builder.AppendLine("<td class='borderAll center col_100' colspan='2'>GC</td>");
            builder.AppendLine("<td class='borderAll center col_100' colspan='2'>GNc</td>");
            builder.AppendLine("<td class='borderAll center col_100' colspan='2'>GCo</td>");
            builder.AppendLine("<td class='borderAll center col_100' colspan='2'>GNs</td></tr><tr>");
        ...
        protected void tworztabelkeHTML13(string idKontrolki, int idWydzialu, int idtabeli, DataTable dane)
        {
            ...
            foreach (DataRow wierszZtabeli in dane.Rows)
            {
                ...
                builder.Append(tb.komorkaHTML("GC", 0, 0, "borderAll center col_100"));
                ...
                builder.Append(tb.komorkaHTML("GNc", 0, 0, "borderAll center col_100"));
                for (int i = 16; i < 29; i++)
                {
                    string txt = "<a Class=\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!" + i.ToString() + "!2')\">" + wierszZtabeli["D_" + i.ToString("D2")].ToString() + " </a>";
                    builder.AppendLine(tb.komorkaHTML(txt, 0, 0, "borderAll center col_50"));
                ...
                builder.AppendLine("</tr>");
                builder.AppendLine("<tr>");
                builder.Append(tb.komorkaHTML("GCo", 0, 0, "borderAll center col_100"));
                for (int i = 30; i < 43; i++)
                {
                    string txt = "<a Class=\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!" + i.ToString() + "!2')\">" + wierszZtabeli["D_" + i.ToString("D2")].ToString() + " </a>";
                    builder.AppendLine(tb.komorkaHTML(txt, 0, 0, "borderAll center col_50"));
                ...
                builder.AppendLine("</tr>");
                builder.AppendLine("<tr>");
                builder.Append(tb.komorkaHTML("GNs", 0, 0, "borderAll center col_100"));
                for (int i = 44; i < 57; i++)
                {
                    string txt = "<a Class=\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!" + i.ToString() + "!2')\">" + wierszZtabeli["D_" + i.ToString("D2")].ToString() + " </a>";
                    builder.AppendLine(tb.komorkaHTML(txt, 0, 0, "borderAll center col_50"));
                ...
                builder.AppendLine("<tr>");
                builder.AppendLine(tb.komorkaHTML("RAZEM", 2, 0, "borderAll center col_50"));
                builder.AppendLine(tb.komorkaHTML("<a Class =\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!57!2')\">" + wierszZtabeli["D_86"].ToString() + " </a>", 3, 0, "borderAll center col_100"));
                builder.AppendLine(tb.komorkaHTML("<a Class =\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!58!2')\">" + wierszZtabeli["D_87"].ToString() + " </a > ", 0, 0, "borderAll center col_50"));
                builder.AppendLine(tb.komorkaHTML("<a Class =\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!59!2')\">" + wierszZtabeli["D_88"].ToString() + " </a > ", 0, 0, "borderAll center col_50"));
                builder.AppendLine(tb.komorkaHTML("<a Class =\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!60!2')\">" + wierszZtabeli["D_89"].ToString() + " </a > ", 0, 0, "borderAll center col_50"));

                builder.AppendLine(tb.komorkaHTML("", 3, 2, "borderAll center col_150"));

                builder.AppendLine(tb.komorkaHTML("<a Class =\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!61!2')\">" + wierszZtabeli["D_90"].ToString() + " </a > ", 0, 0, "borderAll center col_50"));
                builder.AppendLine(tb.komorkaHTML("<a Class =\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!62!2')\">" + wierszZtabeli["D_91"].ToString() + " </a > ", 0, 0, "borderAll center col_50"));
                builder.AppendLine(tb.komorkaHTML("<a Class =\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!63!2')\">" + wierszZtabeli["D_92"].ToString() + " </a > ", 0, 0, "borderAll center col_50"));
            
                builder.AppendLine("</tr>");
                builder.AppendLine("<tr>");
                builder.AppendLine(tb.komorkaHTML("OGÓŁEM za okres oceny", 2, 0, "borderAll center col_50"));
                builder.AppendLine(tb.komorkaHTML("<a Class =\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!2!67')\">000 </a>", 3, 0, "borderAll center col_100"));
                builder.AppendLine(tb.komorkaHTML("<a Class =\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!2!68')\">000 </a>", 0, 0, "borderAll center col_50"));
                builder.AppendLine(tb.komorkaHTML("<a Class =\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!2!69')\">000 </a>", 0, 0, "borderAll center col_50"));
                builder.AppendLine(tb.komorkaHTML("<a Class =\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!2!70')\">000 </a>", 0, 0, "borderAll center col_50"));

                //     builder.AppendLine(tb.komorkaHTML("<a Class =\"normal\" href=\"javascript: openPopup('popup.aspx?sesja="+ wierszZtabeli["id_sedziego"].ToString() + "!"+idtabeli+"!2!86')\">000 </a>", 3, 2, "borderAll center col_150"));

                builder.AppendLine(tb.komorkaHTML("<a Class =\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!2!71')\">000 </a>", 0, 0, "borderAll center col_50"));
                builder.AppendLine(tb.komorkaHTML("<a Class =\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!2!72')\">000 </a>", 0, 0, "borderAll center col_50"));
                builder.AppendLine(tb.komorkaHTML("<a Class =\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!2!73')\">000 </a>", 0, 0, "borderAll center col_50"));
        ...
        protected void tworztabelkeHTML17(string idKontrolki, int idWydzialu, int idtabeli, DataTable dane, string tekst, string funkcjaSR, string opisDzialu, string nrTabeli)
        {
            ...
            foreach (DataRow wierszZtabeli in dane.Rows)
            {
                ...
                builder.Append(tb.komorkaHTML("GC", 0, 0, "borderAll center "));
                ...
                builder.Append(tb.komorkaHTML("GNc", 0, 0, "borderAll center "));
                for (int i = 15; i < 28; i++)
                {
                    string txt = "<a Class=\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!" + i.ToString() + "!2')\">" + wierszZtabeli["D_" + i.ToString("D2")].ToString() + " </a>";
                    builder.AppendLine(tb.komorkaHTML(txt, 0, 0, "borderAll center "));
                ...
                builder.AppendLine("</tr>");
                builder.AppendLine("<tr>");
                builder.Append(tb.komorkaHTML("GCo", 0, 0, "borderAll center "));
                for (int i = 28; i < 41; i++)
                {
                    string txt = "<a Class=\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!" + i.ToString() + "!2')\">" + wierszZtabeli["D_" + i.ToString("D2")].ToString() + " </a>";
                    builder.AppendLine(tb.komorkaHTML(txt, 0, 0, "borderAll center "));
                ...
                builder.AppendLine("</tr>");
                builder.AppendLine("<tr>");
                builder.Append(tb.komorkaHTML("GNs", 0, 0, "borderAll center "));
                for (int i = 41; i < 54; i++)
                {
                    string txt = "<a Class=\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!" + i.ToString() + "!2')\">" + wierszZtabeli["D_" + i.ToString("D2")].ToString() + " </a>";
                    builder.AppendLine(tb.komorkaHTML(txt, 0, 0, "borderAll center "));
        ...
        protected void tworztabelkeHTML19(string idKontrolki, int idWydzialu, int idtabeli, DataTable dane, string tekst, string funkcjaSR, string opisDzialu, string nrTabeli)
        {
            ...
            foreach (DataRow wierszZtabeli in dane.Rows)
            {
                ...
                builder.Append(tb.komorkaHTML(funkcjaSR + wierszZtabeli["imie"].ToString() + " " + wierszZtabeli["nazwisko"].ToString(), 0, 4, "borderAll center "));
                builder.Append(tb.komorkaHTML(wierszZtabeli["funkcja"].ToString(), 0, 4, "borderAll center "));
                ...
                builder.AppendLine("</tr>");
                builder.AppendLine("<tr>");
                builder.Append(tb.komorkaHTML("RAZEM", 2, 0, "borderAll center "));
                for (int i = 53; i < 67; i++)
                {
                    string txt = "<a Class=\"normal \" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!" + i.ToString() + "!2')\">" + wierszZtabeli["D_" + i.ToString("D2")].ToString() + " </a>";
                    builder.AppendLine(tb.komorkaHTML(txt, 0, 0, "borderAll center gray"));
                ...
                builder.AppendLine("<tr>");
                builder.Append(tb.komorkaHTML("OGÓŁEM za okres oceny", 2, 0, "borderAll center "));
                for (int i = 67; i < 81; i++)
                {
                    string txt = "<a Class=\"normal \" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!" + i.ToString() + "!2')\">" + wierszZtabeli["D_" + i.ToString("D2")].ToString() + " </a>";
                    builder.AppendLine(tb.komorkaHTML(txt, 0, 0, "borderAll center gray"));
        ...
        protected void tworztabelkeHTML23(string idKontrolki, int idWydzialu, int idtabeli, DataTable dane, string tekst, string funkcjaSR, string opisDzialu, string nrTabeli)
        {
            ...
            foreach (DataRow wierszZtabeli in dane.Rows)
            {
                ...
                builder.Append(tb.komorkaHTML(funkcjaSR + wierszZtabeli["imie"].ToString() + " " + wierszZtabeli["nazwisko"].ToString(), 0, 4, "borderAll center "));
                builder.Append(tb.komorkaHTML(wierszZtabeli["funkcja"].ToString(), 0, 4, "borderAll center "));
                builder.Append(tb.komorkaHTML("<a Class=\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!2')\">" + wierszZtabeli["D_01"].ToString() + " </a>", 0, 4, "borderAll center "));
                ...
                builder.AppendLine("</tr>");
                builder.AppendLine("<tr>");
                builder.Append(tb.komorkaHTML("RAZEM", 4, 0, "borderAll center gray "));
                for (int i = 67; i < 83; i++)
                {
                    string txt = "<a Class=\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!" + i.ToString() + "!2')\">" + wierszZtabeli["D_" + i.ToString("D2")].ToString() + " </a>";
                    builder.AppendLine(tb.komorkaHTML(txt, 0, 0, "borderAll center gray"));
                ...
                builder.AppendLine("<tr>");
                builder.Append(tb.komorkaHTML("OGÓŁEM za okres oceny", 4, 0, "borderAll center gray"));
                for (int i = 83; i < 99; i++)
                {
                    string txt = "<a Class=\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!" + i.ToString() + "!2')\">" + wierszZtabeli["D_" + i.ToString("D2")].ToString() + " </a>";
                    builder.AppendLine(tb.komorkaHTML(txt, 0, 0, "borderAll center gray "));
        ...
        protected void tworztabelkeHTML26(string idKontrolki, int idWydzialu, int idtabeli, DataTable dane, string tekst, string funkcjaSR, string opisDzialu, string nrTabeli)
        {
            ...
            foreach (DataRow wierszZtabeli in dane.Rows)
            {
                ...
                builder.Append(tb.komorkaHTML(funkcjaSR + wierszZtabeli["imie"].ToString() + " " + wierszZtabeli["nazwisko"].ToString(), 0, 4, "borderAll center "));
                builder.Append(tb.komorkaHTML(wierszZtabeli["funkcja"].ToString(), 0, 4, "borderAll center "));
                builder.Append(tb.komorkaHTML("<a Class=\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!1!2')\">" + wierszZtabeli["D_01"].ToString() + " </a>", 0, 4, "borderAll center "));
                ...
                builder.AppendLine("</tr>");
                builder.AppendLine("<tr>");
                builder.AppendLine(tb.komorkaHTML("RAZEM", 2, 0, "borderAll center gray"));
                for (int i = 54; i < 69; i++)
                {
                    string txt = "<a Class=\"normal\" href=\"javascript: openPopup('popup.aspx?sesja=" + wierszZtabeli["id_sedziego"].ToString() + "!" + idtabeli + "!" + i.ToString() + "!2')\">" + wierszZtabeli["D_" + i.ToString("D2")].ToString() + " </a>";
                    builder.AppendLine(tb.komorkaHTML(txt, 0, 0, "borderAll center gray"));
