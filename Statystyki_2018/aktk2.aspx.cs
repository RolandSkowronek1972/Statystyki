...
{
    public partial class aktk2 : System.Web.UI.Page
    {
        ...
        public static string tenPlik = "aktk2.aspx";
        ...
        protected void odswiez()
        {
            ...
            try
            {
                DataTable Tabela4 = dr.generuj_dane_do_tabeli_wierszy2018(Date1.Date, Date2.Date, id_dzialu, 4, 8, 8, tenPlik);
                Session["tabelka004"] = Tabela4;
                pisz("tab_4_", 7, 8, Tabela4);
            }
            catch (Exception ex)
            {
                cm.log.Error(tenPlik + " " + ex.Message);
        ...
        protected void makeLabels()
        {
            try
            {
                ...
                if (((Date1.Date.Day == 1) && (Date2.Date.Day == last_day)) && ((Date1.Date.Month == Date2.Date.Month)))
                {
                    ...
                    lbTabela4.Text = "Ruch spraw za miesiąc " + strMonthName + " " + Date2.Date.Year.ToString() + " roku.";
                }
                else
                {
                    ...
                    lbTabela4.Text = "Ruch okres od " + Date1.Text + " do  " + Date2.Text;
                }
        ...
        {
            string path = Server.MapPath("Template") + "\\aktk2.xlsx";
            FileInfo existingFile = new FileInfo(path);

            string download = Server.MapPath("Template") + @"\aktk2";
            ...
            using (ExcelPackage MyExcel = new ExcelPackage(existingFile))
            {
                ...
                tabela.tworzArkuszwExcle(MyExcel.Workbook.Worksheets[1], table, 25, 0, 4, true, true, false, false, false);

                // druga
                DataTable table2 = (DataTable)Session["tabelka002"];
                tabela.tworzArkuszwExcle(MyExcel.Workbook.Worksheets[2], table2, 20, 0, 5, true, false, false, false, false);

                tabela.tworzArkuszwExcleBezSedziow(MyExcel.Workbook.Worksheets[3], (DataTable)Session["tabelka003"], 4, 9, 1, 4, false);

                tabela.tworzArkuszwExcleBezSedziow(MyExcel.Workbook.Worksheets[4], (DataTable)Session["tabelka004"], 7, 9, 2, 3, false);
        ...
        protected void naglowekTabeli_gwTabela1(object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
        {
            ...
            {
                string path = Server.MapPath("XMLHeaders") + "\\aktk2_1.xml";
        ...
        protected void naglowekTabeli_gwTabela2(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.Header)
            {
                string path = Server.MapPath("XMLHeaders") + "\\aktk2_2.xml";
