<%@ Page Title="" Language="C#" UICulture="pl" Culture="pl-PL" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="obbr.aspx.cs" Inherits="Statystyki_2018.obbr" %>
...
&nbsp;<asp:Label ID="Label1" runat="server" Text="Informacja statystyczna o ruchu spraw "></asp:Label>
     ...
     <asp:GridView ID="gwTabela1" runat="server" OnRowCreated="naglowekTabeli_gwTabela1"  AutoGenerateColumns="False"  Width = "100%" ShowHeader = "False" OnRowDataBound="gwTabela1_RowDataBound"  >
       ...
       <asp:TemplateField HeaderText = "d_07" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!3!2"%>')" ><asp:Label ID = "Label_gwTabela1107" runat = "server" Text = '<%# Eval("d_07")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_60"/>
                </asp:TemplateField>
...
<table style="width:100%;">
                   ...
                   <tr>
                      ...
                      <td class="col_168 borderAll">Rc</td>
                    ...
                    <tr>
                      ...
                      <td class="col_168 borderAll">RNs</td>
                      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=2!3!1!3')">  <asp:Label CssClass="normal" ID="tab_7_w02_c01" runat="server" Text="0"></asp:Label>  </a></td>
					
                      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=2!3!2!3')">  <asp:Label CssClass="normal" ID="tab_7_w02_c02" runat="server" Text="0"></asp:Label>  </a></td>
					
                      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=2!3!3!3')">  <asp:Label CssClass="normal" ID="tab_7_w02_c03" runat="server" Text="0"></asp:Label>  </a></td>
				      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=2!3!4!3')">  <asp:Label CssClass="normal" ID="tab_7_w02_c04" runat="server" Text="0"></asp:Label>  </a></td>
				      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=2!3!5!3')">  <asp:Label CssClass="normal" ID="tab_7_w02_c05" runat="server" Text="0"></asp:Label>  </a></td>
				      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=2!3!6!3')">  <asp:Label CssClass="normal" ID="tab_7_w02_c06" runat="server" Text="0"></asp:Label>  </a></td>
				      
                   </tr>
                   <tr>
                       <td class="col_168 borderAll">RNsm</td>
                      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=3!3!1!3')">  <asp:Label CssClass="normal" ID="tab_7_w03_c01" runat="server" Text="0"></asp:Label>  </a></td>
					
                      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=3!3!2!3')">  <asp:Label CssClass="normal" ID="tab_7_w03_c02" runat="server" Text="0"></asp:Label>  </a></td>
					
                      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=3!3!3!3')">  <asp:Label CssClass="normal" ID="tab_7_w03_c03" runat="server" Text="0"></asp:Label>  </a></td>
				      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=3!3!4!3')">  <asp:Label CssClass="normal" ID="tab_7_w03_c04" runat="server" Text="0"></asp:Label>  </a></td>
				      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=3!3!5!3')">  <asp:Label CssClass="normal" ID="tab_7_w03_c05" runat="server" Text="0"></asp:Label>  </a></td>
				      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=3!3!6!3')">  <asp:Label CssClass="normal" ID="tab_7_w03_c06" runat="server" Text="0"></asp:Label>  </a></td>
                   </tr>
             <tr>
                       <td class="col_168 borderAll">Nkd</td>
                      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=4!3!1!3')">  <asp:Label CssClass="normal" ID="tab_7_w04_c01" runat="server" Text="0"></asp:Label>  </a></td>
					
                      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=4!3!2!3')">  <asp:Label CssClass="normal" ID="tab_7_w04_c02" runat="server" Text="0"></asp:Label>  </a></td>
					
                      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=4!3!3!3')">  <asp:Label CssClass="normal" ID="tab_7_w04_c03" runat="server" Text="0"></asp:Label>  </a></td>
				      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=4!3!4!3')">  <asp:Label CssClass="normal" ID="tab_7_w04_c04" runat="server" Text="0"></asp:Label>  </a></td>
				      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=4!3!5!3')">  <asp:Label CssClass="normal" ID="tab_7_w04_c05" runat="server" Text="0"></asp:Label>  </a></td>
				      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=4!3!6!3')">  <asp:Label CssClass="normal" ID="tab_7_w04_c06" runat="server" Text="0"></asp:Label>  </a></td>
                   </tr>
                             <tr>
                       <td class="col_168 borderAll">Razem</td>
                      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=5!3!1!3')">  <asp:Label CssClass="normal" ID="tab_7_w05_c01" runat="server" Text="0"></asp:Label>  </a></td>
					
                      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=5!3!2!3')">  <asp:Label CssClass="normal" ID="tab_7_w05_c02" runat="server" Text="0"></asp:Label>  </a></td>
					
                      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=5!3!3!3')">  <asp:Label CssClass="normal" ID="tab_7_w05_c03" runat="server" Text="0"></asp:Label>  </a></td>
				      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=5!3!4!3')">  <asp:Label CssClass="normal" ID="tab_7_w05_c04" runat="server" Text="0"></asp:Label>  </a></td>
				      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=5!3!5!3')">  <asp:Label CssClass="normal" ID="tab_7_w05_c05" runat="server" Text="0"></asp:Label>  </a></td>
				      <td class="col_168 borderAll"><a href="javascript:openPopup('popup.aspx?sesja=5!3!6!3')">  <asp:Label CssClass="normal" ID="tab_7_w05_c06" runat="server" Text="0"></asp:Label>  </a></td>
                   </tr>
