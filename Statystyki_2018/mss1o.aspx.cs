    ...
    public partial class mss1o : System.Web.UI.Page
    {
        ...
        protected void rysuj(DataTable tabela2)
        {
            ...
            try
            {
                ...
                tabelaGlowna.AppendLine(ms.odczytXML(path, int.Parse((string)Session["id_dzialu"]), "1.1.1.1", tabela2, tenPlik));
                tabelaGlowna.AppendLine(ms.odczytXML(path, int.Parse((string)Session["id_dzialu"]), "1.1.1.2", tabela2, tenPlik));
                tabelaGlowna.AppendLine(ms.odczytXML(path, int.Parse((string)Session["id_dzialu"]), "1.1.1.3", tabela2, tenPlik));
