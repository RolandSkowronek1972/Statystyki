...
{
    public partial class onsuOLD : System.Web.UI.Page
    {
        ...
        protected void podlacz(string id_tabeli, string id_sedziego, string id_kolumny)
        {
            ...
            try
            {
                try
                {
                    if (Session["date_1"] == null)
                    {
                        Session["date_1"] = DateTime.Parse(Date1.Text.Trim());
                    }
                }
                catch (Exception)
                { }
                try
                {
                    if (Session["date_2"] == null)
                    {
                        Session["date_2"] = DateTime.Parse(Date2.Text.Trim());
                    }
                }
                catch (Exception)
                { }
