...
namespace Statystyki_2018
{
    public partial class aoppN : System.Web.UI.Page
    {
        ...
        private const string tenPlikNazwa = "aoppN";
        private string path = "";
        ...
        protected void tworzPlikExcell(object sender, EventArgs e)
        {
            ...
            using (ExcelPackage MyExcel = new ExcelPackage(existingFile))
            {
                ...
                MyWorksheet1 = tb.tworzArkuszwExcle(MyExcel.Workbook.Worksheets[1], (DataTable)Session["tabelka001"], 33, 0, 7, true, true, false, false, false);
        ...
        protected void tabela_1()
        {
         ...
         //   DataTable tabelka01 = dr.generuj_dane_do_tabeli_sedziowskiej_2019(int.Parse(idDzialu), 1, Date1.Date, Date2.Date, 400, tenPlik);
            ...
            try
            {
                Session["tabelka001"] = dr.generuj_dane_do_tabeli_sedziowskiej_2019(int.Parse(idDzialu), 1, Date1.Date, Date2.Date, 400, tenPlik);
