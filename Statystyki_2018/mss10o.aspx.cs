...
{
    public partial class mss10o : System.Web.UI.Page
    {
        public Class1 cl = new Class1();
        public mss ms = new mss();
        public common cm = new common();
        public datyDoMSS datyMSS = new datyDoMSS();
        public static string tenPlik = "mss10o.aspx";
        ...
        protected void rysuj()
        {
            ...
            try
            {
                ...
                //wypełnianie lebeli
                string path = Server.MapPath("XMLHeaders") + "\\" + "MSS10o.xml";
                string[] numeryTabel00 = new string[] { "1", "2.1", "2.2", "3.1", "3.2", "3.3" };
                ...
                ms.TworzTabelizListy(numeryTabel05, tablePlaceHolder05, path, tabela2, idWydzialuNumerycznie, tenPlik);
                ms.TworzTabelizListy(numeryTabel06, tablePlaceHolder06, path, tabela2, idWydzialuNumerycznie, tenPlik);
                ms.TworzTabelizListy(numeryTabel07, tablePlaceHolder07, path, tabela2, idWydzialuNumerycznie, tenPlik);
                ms.TworzTabelizListy(numeryTabel08, tablePlaceHolder08, path, tabela2, idWydzialuNumerycznie, tenPlik);
                ms.TworzTabelizListy(numeryTabel09, tablePlaceHolder09, path, tabela2, idWydzialuNumerycznie, tenPlik);
                ms.TworzTabelizListy(numeryTabel10, tablePlaceHolder10, path, tabela2, idWydzialuNumerycznie, tenPlik);
                ms.TworzTabelizListy(numeryTabel11, tablePlaceHolder11, path, tabela2, idWydzialuNumerycznie, tenPlik);
            }
            catch (Exception ex)
            {
...
#pragma warning restore CS0168 // The variable 'ex' is declared but never used
        ...
        protected void makeCSVFile(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    DataTable tabela2 = ms.generuj_dane_do_tabeli_mss2(int.Parse((string)Session["id_dzialu"]), Date1.Date, Date2.Date, 21);
                    //    DataTable tabela2 = mss.generuj_dane_do_tabeli_mss2(int.Parse((string)Session["id_dzialu"]), Date1.Date, Date2.Date, 21); //dane
