<%@ Page Title="" Language="C#" UICulture="pl" Culture="pl-PL" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="obbp.aspx.cs" Inherits="Statystyki_2018.obbp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 1150px; margin: 0 auto 0 auto; position: relative; top: 30px;">
        <br />
        <div class="center">
            &nbsp;<asp:Label ID="Label31" runat="server" Style="font-weight: 700"></asp:Label>
        </div>
        <div class="horizont">
        ...
        <div class="page-break">
            &nbsp;Wykaz terminowości sporządzania uzasadnień z orzeczeń&nbsp;&nbsp;&nbsp;
