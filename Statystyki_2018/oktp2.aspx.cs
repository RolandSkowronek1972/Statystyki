...
{
    public partial class oktp2 : System.Web.UI.Page
    {
        ...
        private const string tenPlik = "oktp2.aspx";
        ...
        public void AddNewRow(object sender, GridViewRowEventArgs e)
        {
            ...
            try
            {
                GridView1.Controls[0].Controls.AddAt(e.Row.RowIndex + rowIndex, tb.PodsumowanieTabeli(tabelka02, 21, "borderAll center gray"));
            }
            catch
            {
            }
            ...
            int idWiersza = 1;
            GridView1.Controls[0].Controls.AddAt(e.Row.RowIndex + rowIndex, tb.wierszTabeli(tabelka01, 9, idWiersza, idtabeli, "Pozostało z poprzedniego okresu", 6, 1, "", "borderAll center"));

            idWiersza = 2;
            GridView1.Controls[0].Controls.AddAt(e.Row.RowIndex + rowIndex, tb.wierszTabeli(tabelka01, 9, idWiersza, idtabeli, "Wpłynęło", 6, 1, "", "borderAll center"));
            
            idWiersza = 3;
            GridView1.Controls[0].Controls.AddAt(e.Row.RowIndex + rowIndex, tb.wierszTabeli(tabelka01, 9, idWiersza, idtabeli, "Załatwiono", 6, 1, "", "borderAll center"));
            
            idWiersza = 4;
            GridView1.Controls[0].Controls.AddAt(e.Row.RowIndex + rowIndex, tb.wierszTabeli(tabelka01, 9, idWiersza, idtabeli, "Pozostało na następny okres", 6, 1, "", "borderAll center"));
        ...
        {
            string path = Server.MapPath("Template") + "\\oktp2.xlsx";
            FileInfo existingFile = new FileInfo(path);
            string download = Server.MapPath("Template") + @"\oktp2";
