<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PopupLinkButtom2.ascx.cs" Inherits="Statystyki_2018.UserControlls.PopupLinkButtom2" %>
...
<div class="first ">
    <table style="width: 100%;clear:both;">
        <tr>
            <td align="center"> <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" CssClass="normal">LinkButton</asp:LinkButton>
  </td>
          ...
          <asp:Panel ID="Panel1" runat="server"  Visible="False"  >
              ...
              <div class="popUpNow" style="margin-left:-55em">
                 <table width="100%" >
                <tr>
                    <td style="text-align:left;">
                        ...
                        <asp:Label ID="Label22" runat="server" CssClass="normal" Font-Bold="True" ForeColor="Black"></asp:Label>
