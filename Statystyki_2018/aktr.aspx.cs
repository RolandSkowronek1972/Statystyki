...
{
    public partial class aktr : System.Web.UI.Page
    {
        ...
        private const string fileId = "aktr";
        private const string tenPlik = "aktr.aspx";
        ...
        protected void odswiez()
        {
            try
            {
                ...
                Tabele.Append(xMLHeaders.TabelaSedziowskaXML(path, int.Parse(idDzialu), "1", Tabela1, false, false, false,true,  cm.tekstNadTabelą("Statystyka miesięczna Wydział Cywilny Rodzinny Tabela 1 ", Date1.Date, Date2.Date), tenPlik));
                Tabele.Append(xMLHeaders.TabelaWierszyXML(path, int.Parse(idDzialu), "2", Tabela2, false, false, false, true, cm.tekstNadTabelą("Statystyka miesięczna Wydział Cywilny Rodzinny Tabela 2 ", Date1.Date, Date2.Date), tenPlik));
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            using (ExcelPackage MyExcel = new ExcelPackage(existingFile))
            {
                ...
                MyWorksheet1 = tb.tworzArkuszwExcle(MyExcel.Workbook.Worksheets[1], (DataTable)Session["tabelka001"], 34, 0, 5, true, true, false, false, false);
                MyWorksheet1 = tb.tworzArkuszwExcleBezSedziow(MyExcel.Workbook.Worksheets[2], (DataTable)Session["tabelka002"], 20,12,2,2, false);
                try
                {
