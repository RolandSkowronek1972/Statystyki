<%@ Page Title="" Language="C#" UICulture="pl" Culture="pl-PL" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="wizg.aspx.cs" Inherits="Statystyki_2018.wizg" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 1150px; margin: 0 auto 0 auto; position: relative; top: 30px;" class="content landscape">
        ...
        <div class="page-break">
            ...
            <table class="borderAll  center">
                ...
                <tr>
                    <td class="borderAll ">&nbsp;OGÓŁEM za okres oceny</td>
        ...
        <asp:Label ID="infoLabel12" runat="server" Text="tabela 12  \/\/\/" Visible="False"></asp:Label>
            ...
            <div id="TABELA5" class="page-break">
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td class="borderAll center">GCo</td>
                        <td class="borderAll center col_81">
                    ...
                    <tr>
                        <td class="borderAll center">GNs</td>
                        <td class="borderAll center col_81">
 ...
 <table style="width: 100%;">
     ...
     <tr>
         <td class="col_80_fest_fest borderAll">GC</td>
     ...
     <tr>
         <td class="col_80_fest_fest borderAll">GNc</td>
         <td class="col_80_fest_fest borderAll">
     ...
     <tr>
         <td class="col_80_fest_fest borderAll">GCo</td>
         <td class="col_80_fest_fest borderAll">
     ...
     <tr>
         <td class="col_80_fest_fest borderAll">GNs</td>
         <td class="col_80_fest_fest borderAll">
     ...
     <tr>
         <td class="col_80_fest_fest borderAll gray" colspan="2">Ogółem</td>
        ...
        <div id="TABELA31" class="page-break">
          ...
          kwota zasądzonego odszko-dowania</td>
                ...
                <tr>
                    <td class="borderAll center gray col_70">GC</td>
                ...
                <tr>
                    <td class="borderAll center gray col_70">GNc</td>
                    <td class="borderAll col_90">
                ...
                <tr>
                    <td class="borderAll center gray col_70">GCo</td>
                    <td class="borderAll col_90">
                ...
                <tr>
                    <td class="borderAll center gray col_70">GNs</td>
                    <td class="borderAll col_90">
        ...
        <div class="page-break">
            ...
            <table style="width: 100%;">
                <tr>
                    <td>V.2. Uwagi do organizacji pracy wydziału w zakresie toku wewnętrznego urzędowania sądu        <asp:TextBox CssClass="normal center" ID="tab_32_w01_c01" runat="server"></asp:TextBox></td>
                </tr>
                <tr>
