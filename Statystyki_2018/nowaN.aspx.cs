...
{
    public partial class nowaN : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    nazwa = cm.getQuerryValue("SELECT opis FROM konfig  WHERE (ident = @ident) and klucz='kontrolka'", cm.con_str, parameters);
                }
                catch
                { }
