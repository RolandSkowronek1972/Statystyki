<%@ Page Title="" Language="C#" UICulture="pl" Culture="pl-PL" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="akac.aspx.cs" Inherits="Statystyki_2018.akac" AspCompat="true" MaintainScrollPositionOnPostback="true" %>
        ...
        <div id="Div2" style="z-index: 10;">
            ...
            <table cellpadding="0" cellspacing="0" class="auto-style2">
                <tr>
                    ...
                    <td align="center" colspan="13" class="auto-style3">
                        <asp:Label ID="Label712" runat="server" Text="I instancja" Font-Bold="True" Font-Italic="True" Font-Size="Medium"></asp:Label></td>
                    <td class="auto-style3"></td>
                    <td align="center" class="auto-style3" colspan="6">
                        <asp:Label ID="Label46" runat="server" Text="II instancja" Font-Bold="True" Font-Italic="True" Font-Size="Medium"></asp:Label></td>
                </tr>
                ...
                <tr>
                    ...
                    <td align="center" colspan="4" style="border-style: solid; border-width: medium thin thin thin; border-color: #000000;">
                        <asp:Label ID="Label23" runat="server" Text="C"></asp:Label></td>
                    <td align="center" colspan="3" style="border-style: solid; border-width: medium thin thin thin; border-color: #000000;">
                        <asp:Label ID="Label60" runat="server" Text="Ns"></asp:Label></td>
                    <td rowspan="2" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;" align="center">
                        <asp:Label ID="Label81" runat="server" Text="CG-G"></asp:Label></td>
                    <td rowspan="2" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;" align="center">
                        <asp:Label ID="Label82" runat="server" Text="Ns-Rej."></asp:Label></td>
                    <td rowspan="2" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;" align="center">
                        <asp:Label ID="Label83" runat="server" Text="Co"></asp:Label></td>
                    <td rowspan="2" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;" align="center">
                        <asp:Label ID="Label84" runat="server" Text="Nc"></asp:Label></td>
                    <td rowspan="2" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;" align="center">
                        <asp:Label ID="Label85" runat="server" Text="WSC"></asp:Label></td>
                    <td rowspan="2" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;" align="center">
                        <asp:Label ID="Label86" runat="server" Text="RAZEM"></asp:Label></td>
                    <td align="center">&nbsp;</td>
                    <td rowspan="2" align="center" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;">
                        <asp:Label ID="Label112" runat="server" Text="Ca"></asp:Label></td>
                    <td rowspan="2" align="center" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;">
                        <asp:Label ID="Label113" runat="server" Text="Cz"></asp:Label></td>
                    <td rowspan="2" align="center" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;">
                        <asp:Label ID="Label90" runat="server" Text="Co"></asp:Label></td>
                    <td rowspan="2" align="center" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;">
                        <asp:Label ID="Label91" runat="server" Text="WSC"></asp:Label></td>
                    <td rowspan="2" align="center" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;">
                        <asp:Label ID="Label92" runat="server" Text="Wykaz S"></asp:Label></td>
                    <td rowspan="2" align="center" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;">
                        <asp:Label ID="Label93" runat="server" Text="RAZEM"></asp:Label></td>
                </tr>
                <tr>
                    <td style="border-style: solid; border-width: thin thin medium thin; border-color: #000000;" align="center">
                        <asp:Label ID="Label98" runat="server" Text="rozwody"></asp:Label></td>
                    <td style="border-style: solid; border-width: thin thin medium thin; border-color: #000000;" align="center">
                        <asp:Label ID="Label99" runat="server" Text="separacje"></asp:Label></td>
                    <td style="border-style: solid; border-width: thin thin medium thin; border-color: #000000;" align="center">
                        <asp:Label ID="Label100" runat="server" Text="pozostałe"></asp:Label></td>
                    <td style="border-style: solid; border-width: thin thin medium thin; border-color: #000000;" align="center">
                        <asp:Label ID="Label101" runat="server" Text="RAZEM"></asp:Label></td>
                    <td style="border-style: solid; border-width: thin thin medium thin; border-color: #000000;" align="center">
                        <asp:Label ID="Label102" runat="server" Text="separacje"></asp:Label></td>
                    <td style="border-style: solid; border-width: thin thin medium thin; border-color: #000000;" align="center">
                        <asp:Label ID="Label103" runat="server" Text="inne"></asp:Label></td>
                    <td style="border-style: solid; border-width: thin thin medium thin; border-color: #000000;" align="center">
                ...
                <tr>
                    ...
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=1!1!15!3')">
                        <asp:Label CssClass="normal" ID="LB_116" runat="server" Text="0"></asp:Label></a> </td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=1!1!16!3')">
                        <asp:Label CssClass="normal" ID="LB_117" runat="server" Text="0"></asp:Label></a> </td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=1!1!17!3')">
                        <asp:Label CssClass="normal" ID="LB_118" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=1!1!18!3')">
                        <asp:Label CssClass="normal" ID="LB_119" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px medium 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=1!1!19!3')">
                        <asp:Label CssClass="normal" ID="LB_120" runat="server" Text="0"></asp:Label></a></td>
                </tr>
                <tr>
                    ...
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=2!1!15!3')">
                        <asp:Label CssClass="normal" ID="LB_216" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=2!1!16!3')">
                        <asp:Label CssClass="normal" ID="LB_217" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=2!1!17!3')">
                        <asp:Label CssClass="normal" ID="LB_218" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=2!1!18!3')">
                        <asp:Label CssClass="normal" ID="LB_219" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px medium 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=1!1!19!3')">
                        <asp:Label CssClass="normal" ID="LB_220" runat="server" Text="0"></asp:Label></a></td>
                </tr>
                <tr>
                    ...
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=3!1!15!3')">
                        <asp:Label CssClass="normal" ID="LB_316" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=3!1!16!3')">
                        <asp:Label CssClass="normal" ID="LB_317" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=3!1!17!3')">
                        <asp:Label CssClass="normal" ID="LB_318" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=3!1!18!3')">
                        <asp:Label CssClass="normal" ID="LB_319" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px medium 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=3!1!19!3')">
                        <asp:Label CssClass="normal" ID="LB_320" runat="server" Text="0"></asp:Label></a></td>
                </tr>
                <tr>
                    <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000;" align="center">
                    ...
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=4!1!15!3')">
                        <asp:Label CssClass="normal" ID="LB_416" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=4!1!16!3')">
                        <asp:Label CssClass="normal" ID="LB_417" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=4!1!17!3')">
                        <asp:Label CssClass="normal" ID="LB_418" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=4!1!18!3')">
                        <asp:Label CssClass="normal" ID="LB_419" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px medium 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=4!1!19!3')">
                        <asp:Label CssClass="normal" ID="LB_420" runat="server" Text="0"></asp:Label></a></td>
                </tr>
                <tr>
                    ...
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=5!1!15!3')">
                        <asp:Label CssClass="normal" ID="LB_516" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=5!1!16!3')">
                        <asp:Label CssClass="normal" ID="LB_517" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=5!1!17!3')">
                        <asp:Label CssClass="normal" ID="LB_518" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=5!1!18!3')">
                        <asp:Label CssClass="normal" ID="LB_519" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px medium 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=5!1!19!3')">
                        <asp:Label CssClass="normal" ID="LB_520" runat="server" Text="0"></asp:Label></a></td>
                </tr>
                <tr>
                    <td colspan="2" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000;" align="center">
                    ...
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=6!1!15!3')">
                        <asp:Label CssClass="normal" ID="LB_616" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=6!1!16!3')">
                        <asp:Label CssClass="normal" ID="LB_617" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=6!1!17!3')">
                        <asp:Label CssClass="normal" ID="LB_618" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=6!1!18!3')">
                        <asp:Label CssClass="normal" ID="LB_619" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px medium 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=6!1!19!3')">
                        <asp:Label CssClass="normal" ID="LB_620" runat="server" Text="0"></asp:Label></a></td>
                </tr>
                <tr>
                    ...
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=7!1!15!3')">
                        <asp:Label CssClass="normal" ID="LB_716" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=7!1!16!3')">
                        <asp:Label CssClass="normal" ID="LB_717" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=7!1!17!3')">
                        <asp:Label CssClass="normal" ID="LB_718" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=7!1!18!3')">
                        <asp:Label CssClass="normal" ID="LB_719" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px medium 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=7!1!19!3')">
                        <asp:Label CssClass="normal" ID="LB_720" runat="server" Text="0"></asp:Label></a></td>
                </tr>
                <tr>
                    ...
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=8!1!15!3')">
                        <asp:Label CssClass="normal" ID="LB_816" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=8!1!16!3')">
                        <asp:Label CssClass="normal" ID="LB_817" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=8!1!17!3')">
                        <asp:Label CssClass="normal" ID="LB_818" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=8!1!18!3')">
                        <asp:Label CssClass="normal" ID="LB_819" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px medium 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=8!1!19!3')">
                        <asp:Label CssClass="normal" ID="LB_820" runat="server" Text="0"></asp:Label></a></td>
                </tr>
                <tr>
                    <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000;" align="center">
                    ...
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=9!1!15!3')">
                        <asp:Label CssClass="normal" ID="LB_916" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=9!1!16!3')">
                        <asp:Label CssClass="normal" ID="LB_917" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=9!1!17!3')">
                        <asp:Label CssClass="normal" ID="LB_918" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=9!1!18!3')">
                        <asp:Label CssClass="normal" ID="LB_919" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px medium 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=9!1!19!3')">
                        <asp:Label CssClass="normal" ID="LB_920" runat="server" Text="0"></asp:Label></a></td>
                </tr>
                <tr>
                    <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000;" align="center">
                    ...
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=10!1!15!3')">
                        <asp:Label CssClass="normal" ID="LB_1016" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=10!1!16!3')">
                        <asp:Label CssClass="normal" ID="LB_1017" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=10!1!17!3')">
                        <asp:Label CssClass="normal" ID="LB_1018" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=10!1!18!3')">
                        <asp:Label CssClass="normal" ID="LB_1019" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px medium 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=10!1!19!3')">
                        <asp:Label CssClass="normal" ID="LB_1020" runat="server" Text="0"></asp:Label></a></td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style2" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000;" align="center">
                    ...
                    <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=11!1!1!3')">
                        <asp:Label CssClass="normal" ID="LB_11_1" runat="server" Text="0"></asp:Label></a></td>
                    <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=11!1!2!3')">
                        <asp:Label CssClass="normal" ID="LB_11_2" runat="server" Text="0"></asp:Label></a></td>
                    <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=11!1!3!3')">
                        <asp:Label CssClass="normal" ID="LB_11_3" runat="server" Text="0"></asp:Label></a></td>
                    <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=11!1!4!3')">
                        <asp:Label CssClass="normal" ID="LB_11_4" runat="server" Text="0"></asp:Label></a></td>
                    <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=11!1!5!3')">
                        <asp:Label CssClass="normal" ID="LB_11_5" runat="server" Text="0"></asp:Label></a></td>
                    <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=11!1!6!3')">
                        <asp:Label CssClass="normal" ID="LB_11_6" runat="server" Text="0"></asp:Label></a></td>
                    <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=11!1!7!3')">
                        <asp:Label CssClass="normal" ID="LB_11_7" runat="server" Text="0"></asp:Label></a></td>
                    <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=11!1!8!3')">
                        <asp:Label CssClass="normal" ID="LB_11_8" runat="server" Text="0"></asp:Label></a></td>
                    ...
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=11!1!15!3')">
                        <asp:Label CssClass="normal" ID="LB_1116" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=11!1!16!3')">
                        <asp:Label CssClass="normal" ID="LB_1117" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=11!1!17!3')">
                        <asp:Label CssClass="normal" ID="LB_1118" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=11!1!18!3')">
                        <asp:Label CssClass="normal" ID="LB_1119" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px medium 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=11!1!19!3')">
                        <asp:Label CssClass="normal" ID="LB_1120" runat="server" Text="0"></asp:Label></a></td>
                </tr>
                <tr>
                    <td colspan="3" style="border-style: solid; border-width: 0px 0px 1px medium; border-color: #000000;" align="center">
                    ...
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=12!1!15!3')">
                        <asp:Label CssClass="normal" ID="LB_1216" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=12!1!16!3')">
                        <asp:Label CssClass="normal" ID="LB_1217" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=12!1!17!3')">
                        <asp:Label CssClass="normal" ID="LB_1218" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=12!1!18!3')">
                        <asp:Label CssClass="normal" ID="LB_1219" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px medium 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=12!1!19!3')">
                        <asp:Label CssClass="normal" ID="LB_1220" runat="server" Text="0"></asp:Label></a></td>
                </tr>
                <tr>
                    <td colspan="3" style="border-style: solid; border-width: 0px 0px 1px medium; border-color: #000000;" align="center">
                    ...
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=13!1!15!3')">
                        <asp:Label CssClass="normal" ID="LB_1316" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=13!1!16!3')">
                        <asp:Label CssClass="normal" ID="LB_1317" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=13!1!17!3')">
                        <asp:Label CssClass="normal" ID="LB_1318" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=13!1!18!3')">
                        <asp:Label CssClass="normal" ID="LB_1319" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px medium 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=13!1!19!3')">
                        <asp:Label CssClass="normal" ID="LB_1320" runat="server" Text="0"></asp:Label></a></td>
                </tr>
                <tr>
                    ...
                    <td align="center" style="border-style: solid; border-width: 0px 0px medium 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=14!1!15!3')">
                        <asp:Label CssClass="normal" ID="LB_1416" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px medium 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=14!1!16!3')">
                        <asp:Label CssClass="normal" ID="LB_1417" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px medium 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=14!1!17!3')">
                        <asp:Label CssClass="normal" ID="LB_1418" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px 0px medium 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=14!1!18!3')">
                        <asp:Label CssClass="normal" ID="LB_1419" runat="server" Text="0"></asp:Label></a></td>
                    <td align="center" style="border-style: solid; border-width: 0px medium medium 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=14!1!19!3')">
                        <asp:Label CssClass="normal" ID="LB_1420" runat="server" Text="0"></asp:Label></a></td>
                </tr>
            </table>
                    ...
                    <asp:TemplateField HeaderText="d_07" SortExpression="d_07">
                        <ItemTemplate>
                            <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!28!2"%>')">
                                <asp:Label ID="Label228" runat="server" Text='<%# Eval("d_28")%>' CssClass="normal"></asp:Label>
                            </a>
                        </ItemTemplate>
                        <ItemStyle CssClass="col_37" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="d_07" SortExpression="d_07">
                        <ItemTemplate>
                            <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!29!2"%>')">
                                <asp:Label ID="Label229" runat="server" Text='<%# Eval("d_29")%>' CssClass="normal"></asp:Label>
                            </a>
                        </ItemTemplate>
                        <ItemStyle CssClass="col_37" />
                    </asp:TemplateField>
            ...
            <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                        ...
                        <ItemTemplate>
                            <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!20!2"%>')">
                                <asp:Label ID="Label420" runat="server" Text='<%# Eval("d_20")%>' CssClass="normal"></asp:Label>
                            </a>
                        </ItemTemplate>
                        <ItemStyle CssClass="col_50" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                        ...
                        <ItemTemplate>
                            <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!21!2"%>')">
                                <asp:Label ID="Label421" runat="server" Text='<%# Eval("d_21")%>' CssClass="normal"></asp:Label>
                            </a>
                        </ItemTemplate>
                        <ItemStyle CssClass="col_50" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                        ...
                        <ItemTemplate>
                            <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!22!2"%>')">
                                <asp:Label ID="Label422" runat="server" Text='<%# Eval("d_22")%>' CssClass="normal"></asp:Label>
                            </a>
                        </ItemTemplate>
                        <ItemStyle CssClass="col_50" />
                    </asp:TemplateField>
